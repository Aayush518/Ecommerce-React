    ...
    const slides = [
        {
            ...
            image: heroBag,
            backText: 'Prayush',
            description: 'Discover the epitome of style and craftsmanship with our curated leather bag collection.'
        },
        {
    ...
    return (
        <div className="Hero">
            <div className="hero-container">
                ...
                >
                    <h1 className="text-right">{slides[currentSlide].title[0]}</h1>
                    <h1 className="text-left">{slides[currentSlide].title[1]}</h1>
                </div>
                ...
                <div 
                    className="top-link d-flex flex-column gap-1"
